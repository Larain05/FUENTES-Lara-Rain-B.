# FUENTES-Lara-Rain-B.
Using the Pendulum Period formula, I compared Truncation vs. Rounding to see which method minimizes error. This shows pi as a fundamental constant of time and gravity, not just circles.
